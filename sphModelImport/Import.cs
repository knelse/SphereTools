...
public partial class Import : Node3D
{
    ...
    public override void _Ready ()
    {
        ...
        foreach (var file in modelFiles)
        {
            ...
            ResourceSaver.Save(arrayMesh, $"res://models/{Path.GetFileNameWithoutExtension(file)}.tres",
        ...
        // var error = ResourceSaver.Save(landscapeScene, "res://TerrainMeshLibrary.tscn",
        //     ResourceSaver.SaverFlags.Compress);
        // if (error != Error.Ok)
        // {
        //     GD.Print(error);
        // }
        //
        // using var mapFile = File.OpenRead(@"c:\Games\Sfera_std\landscape\contours.bin");
        ...
        // ResourceSaver.Save(arrayMesh, "res://contours.tres", ResourceSaver.SaverFlags.Compress);
    ...
    private void ImportLandscapeFiles (string continent)
    {
        ...
        foreach (var filePath in files)
        {
            ...
            var transform = terrain.Transform;
            // transform = transform.Rotated(Vector3.Up, Mathf.Pi);
            // transform.Origin = new Vector3(-50, 0, 50);
            transform = transform.Scaled(new Vector3(1, 1, -1));
            terrain.Transform = transform;
