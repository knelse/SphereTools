...
public static class ObjectTypeToPacketNameMap
{
    public static Dictionary<ObjectType, string> Mapping = new ()
    {
        ...
        [ObjectType.InkpotBroken] = "",
        [ObjectType.ArmorChest] = "item_axe", // generic item packet
        [ObjectType.ArmorAmulet] = "item_axe", // generic item packet
        [ObjectType.ArmorBoots] = "item_axe", // generic item packet
        [ObjectType.ArmorGloves] = "item_axe", // generic item packet
        [ObjectType.ArmorBelt] = "item_axe", // generic item packet
        [ObjectType.ArmorShield] = "item_axe", // generic item packet
        [ObjectType.ArmorHelmet] = "item_axe", // generic item packet
        [ObjectType.ArmorPants] = "item_pants",
        [ObjectType.ArmorBracelet] = "item_axe", // generic item packet
        [ObjectType.Ring] = "item_ring_half",
        [ObjectType.ArmorRobe] = "item_robe_dragon_pa", // item_robe_dragon_pa
        [ObjectType.RingGolem] = "",
